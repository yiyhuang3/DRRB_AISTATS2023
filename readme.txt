...
The 100 Credit datasets are saved in the link https://github.com/PaperandCode/AISTATS_556. The number xxx in "credit_xxx_1-100.test.npz" means the removal ratio. Please open config.txt and modify relevant parameters as used in our paper. Then do the same as IHDP experiments to reproduce the results.